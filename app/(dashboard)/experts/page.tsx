        ...
        <div className="space-y-2.5">
          {filteredExperts.map((ex) => {
            ...
            return (
              ...
              >
                {/* Left Section: Checkbox, Avatar, Name & Role Badge */}
                <div className="flex items-center gap-3.5 min-w-0 flex-1">
                  ...
                  />
                  <div className="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center font-black text-sm text-[var(--foreground)] uppercase shrink-0 shadow-2xs">
                    {ex.name[0]}
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {isAdmin ? (
                        <span className="px-2.5 py-0.5 rounded-full bg-purple-100 text-purple-800 border border-purple-300 text-[9px] font-black uppercase tracking-wider flex items-center gap-1 shrink-0">
                          <ShieldCheckIcon className="w-3 h-3 text-purple-700" /> Admin
                        </span>
                      ) : isTeam ? (
                        <span className="px-2.5 py-0.5 rounded-full bg-blue-100 text-blue-800 border border-blue-300 text-[9px] font-black uppercase tracking-wider flex items-center gap-1 shrink-0">
                          <UsersIcon className="w-3 h-3 text-blue-700" /> Team
                        </span>
                      ) : (
                        <span className="px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-300 text-[9px] font-black uppercase tracking-wider flex items-center gap-1 shrink-0">
                          <UserCheckIcon className="w-3 h-3 text-emerald-700" /> Expert Role
                        </span>
                      )}
                    </div>
                    <p className="text-[11px] text-[var(--muted)] font-medium truncate mt-0.5">{ex.email}</p>
                  </div>
                </div>

                {/* Middle Section: Assigned Modules Tags */}
                ...
                {/* Right Section: Session Count & Actions */}
                <div className="flex items-center justify-between md:justify-end gap-4 border-t md:border-t-0 border-slate-100 pt-2.5 md:pt-0 shrink-0">
                  <span className="text-xs font-bold text-[var(--muted)] bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200/80">
                    <strong className="text-slate-900 font-black">{ex.sessions?.length ?? 0}</strong> Sessions
                  </span>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl text-rose-500 hover:text-rose-700 hover:bg-rose-50 transition-colors border border-transparent hover:border-rose-200"
                      title="Archive User"
                    >
